  ...
  timer: 1500
        ...
        <table class="responsive-table" style="overflow: auto;">
            ...
            <tbody>
                    ...
                    <td>{{$data->proveedor->tipo_persona}}</td>
                    <td>{{$data->proveedor->cedula_rnc}}</td>
                    <td>{{$data->proveedor->balance}}</td>
                    <td>{{$data->fecha_registro}}</td>
                    <td>{{$data->fecha_documento}}</td>
                    <td>{{$data->monto}}</td>
                    <td>{{$data->estado}}</td>
                    <td>   <a href="{{route('edit', $data->id)}}" class="btn btn-success" style="display: block;">
